...
import 'package:ecommerce_app/common/widgets/custom_shape/containers/primary_header_container.dart';
import 'package:ecommerce_app/common/widgets/list_title/settings_menu_tile.dart';
...
import 'package:ecommerce_app/features/personalization/screens/setting/widgets/user_profile_tile.dart';
             ...
             Padding(
              ...
              child: Column(
                children: [
                  ...
                  TSettingsMenuTile(icon: Iconsax.image, title: "HD Image Quantity", subTitle: 'Set image quality to be seen', trailing: Switch(value:false, onChanged: (value){},),),
