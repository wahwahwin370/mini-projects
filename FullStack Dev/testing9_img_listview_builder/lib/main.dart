...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Image Testing (ListView.builder)'),
      ),
      body: ListView.builder(    //if PageView it use one page for one card
        ...
        itemBuilder: (BuildContext context, int index) {
          return Card(
            child: Column(
              children: [
                Container(child: Image.asset(girls[index].img), height: 200,width: 150,),
